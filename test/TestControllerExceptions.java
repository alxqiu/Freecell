...
/**
 * Testing the ability of the controller to throw IllegalArgumentExceptions
 * and IllegalStateExceptions: like when appendable or readable run out of
 * input or reading/writing fails.
 */
public class TestControllerExceptions {
  private SimpleFreecellModel newModel;

  @Before
  public void init() {
    newModel = new SimpleFreecellModel(new Random(700));
  }
  ...
  public void testFailTransmitGameOver() {
    FreecellModel easyModel = new SimpleFreecellModel();
