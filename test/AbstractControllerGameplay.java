...
/**
 * Abstract class for testing Controller moves for both SimpleFreecellModel and
 * MultiFreecellModel. TestControllerGameplay but for both models.
 */
public abstract class AbstractControllerGameplay {

  private FreecellModel<ICard> firstModel;
  private MockBlankModel newBlankModel;
  private MockDynamicModel newDynamicMock;
  private StringBuilder outputText;

  protected abstract FreecellModel<ICard> makeFirstModel();

  @Before
  public void init() {
    firstModel = makeFirstModel();
   ...
   */
  public static class TestSimpleFreecellModel extends AbstractControllerGameplay {

    @Override
    protected FreecellModel<ICard> makeFirstModel() {
      return new SimpleFreecellModel(new Random(552));
    }
  }
   ...
   */
  public static class TestMultiFreecellModel extends AbstractControllerGameplay {

    @Override
    protected FreecellModel<ICard> makeFirstModel() {
      return new MultiFreecellModel(new Random(552));
    }
  }
  ...
  public void couldNotStart() {
    FreecellController newController = new SimpleFreecellController(firstModel,
  ...
  public void testOpeningMessages() {
    FreecellController newCont = new SimpleFreecellController(firstModel,
            new StringReader("q"), outputText);
    newCont.playGame(firstModel.getDeck(), 7, 2, true);
  ...
  public void testGameOverMessage() {
    FreecellController newControls = new SimpleFreecellController(firstModel,
