...
/**
 * Abstract test that holds methods that test exceptions being thrown from
 * both SimpleFreecellModel and MultiFreecellModel implementations of FreecellModel.
 *
 * <p>Is essentially the double-implementation testing version of TestSFMExceptions.</p>
 */
public abstract class AbstractModelExceptionsTest {
  private FreecellModel<ICard> unstartedGame;
  private FreecellModel<ICard> startedGame;

  protected abstract FreecellModel<ICard> constructUnstartedGame();

  protected abstract FreecellModel<ICard> constructStartedGame();

  protected abstract FreecellModel<ICard> constructWithNull();

  @Before
  public void init() {
    unstartedGame = constructUnstartedGame();
    startedGame = constructStartedGame();
  }

  // test constructor exception (tests both)
   ...
   */
  public static class TestSimpleFreecellModel extends AbstractModelExceptionsTest {

    @Override
    protected FreecellModel<ICard> constructUnstartedGame() {
      return new SimpleFreecellModel();
    }

    @Override
    protected FreecellModel<ICard> constructStartedGame() {
      FreecellModel<ICard> startedGame = new SimpleFreecellModel(new Random(21));
      startedGame.startGame(startedGame.getDeck(), 6, 3, true);
      return startedGame;
    }

    @Override
    protected FreecellModel<ICard> constructWithNull() {
      return new SimpleFreecellModel(null);
    }
  }
   ...
   */
  public static class TestMultiFreecellModel extends AbstractModelExceptionsTest {
    ...
    @Override
    protected FreecellModel<ICard> constructStartedGame() {
      FreecellModel<ICard> startedGame = new MultiFreecellModel(new Random(21));
      startedGame.startGame(startedGame.getDeck(), 6, 3, true);
      return startedGame;
    }
    ...
    @Override
    protected FreecellModel<ICard> constructWithNull() {
      return new MultiFreecellModel(null);
    }
  }
}
