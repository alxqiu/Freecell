...
public abstract class AbstractViewToString {
  ...
  public void freshlyStarted() {
    assertEquals(new FreecellTextView(freecellModel1).toString(),
            "F1:\nF2:\nF3:\nF4:\nO1:\nO2:\n"
  ...
  public void afterOneMove() {
    ...
    freecellModel1.move(PileType.CASCADE, 1, 10,
            PileType.OPEN, 1);
    assertEquals(new FreecellTextView(freecellModel1).toString(),
            "F1:\nF2:\nF3:\nF4:\nO1:\nO2: K♠\n"
                    + "C1: A♣, 6♣, J♣, 3♦, 8♦, K♦, 5♥, 10♥, 2♠, 7♠, Q♠\n"
   ...
   */
  public static class TestSimpleFreecellModel extends AbstractViewToString {
    ...
    @Override
    protected FreecellModel<ICard> constructShuffledGame() {
      FreecellModel<ICard> shuffledGame = new SimpleFreecellModel(new Random(123));
   ...
   */
  public static class TestMultiFreecellModel extends AbstractViewToString {
    ...
    @Override
    protected FreecellModel<ICard> constructShuffledGame() {
      FreecellModel<ICard> shuffledGame = new MultiFreecellModel(new Random(123));
      shuffledGame.startGame(shuffledGame.getDeck(), 8, 4, true);
      return shuffledGame;
    }
  }
