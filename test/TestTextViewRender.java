...
/**
 * Test class for the renderBoard and renderMessage methods
 * implemented by FreecellTextView. Also tests exceptions from invalid inputs for the
 * FreecellTextView constructor. For Freecell HW3, the toString() tests from HW2 are
 * in TestTextViewToString
 */
public class TestTextViewRender {
  private SimpleFreecellModel simpleGame;
  ...
  @Before
  public void init() {
    this.simpleGame = new SimpleFreecellModel(new Random(62));
    this.freshBoardHolder = new StringBuilder();
    this.freshBoard = new FreecellTextView(simpleGame, freshBoardHolder);
  }
  ...
  public void givenNullOutput() {
    new FreecellTextView(this.simpleGame, null);
  }
  ...
  public void noAppendingBoard() throws IOException {
    this.simpleGame.startGame(this.simpleGame.getDeck(), 4, 1, true);
    ...
    FreecellTextView viewToFail = new FreecellTextView(this.simpleGame, noSpaceToAppendHere);
  ...
  public void testRenderFreshBoard() throws IOException {
    ...
    simpleGame.startGame(simpleGame.getDeck(), 4, 3, true);
  ...
  public void testRenderSomeBoardMoves() throws IOException {
    simpleGame.startGame(simpleGame.getDeck(), 7, 4, true);
    /*
    ...
    simpleGame.move(PileType.CASCADE, 2, 7, PileType.CASCADE, 4);
    // moving 6♠ from C4 to C5
    simpleGame.move(PileType.CASCADE, 3, 6, PileType.CASCADE, 4);
    // moving A♣ from C4 to F2
    simpleGame.move(PileType.CASCADE, 3, 5, PileType.FOUNDATION, 1);
    freshBoard.renderBoard();
    assertEquals(freshBoardHolder.toString(),
            "F1:\n"
                    + "F2: A♣\n"
